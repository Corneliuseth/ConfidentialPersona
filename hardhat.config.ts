...
import "./tasks/ConfidentialPersona";

// Read from .env first, fallback to hardhat vars
...
const config: HardhatUserConfig = {
  ...
  networks: {
    ...
    sepolia: {
      accounts: PRIVATE_KEY ? [PRIVATE_KEY] : { mnemonic: MNEMONIC, path: "m/44'/60'/0'/0/", count: 1 },
      chainId: 11155111,
